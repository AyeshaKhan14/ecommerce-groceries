          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item dropdown navbar-dark">
              ...
              <ul
                ...
                aria-labelledby="navbarDropdown colorset"
              >
                <li>
                  <span className="dropdown-item" href="/#products">
                    <Link className="navbar-brand" to="/fresh">
                      Fresh Grocery
                    </Link>
                  </span>
                </li>
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 mx-lg-2 order-sm-last ">
              ...
              >
                <Link className="nav-link colorset" to="/cart" tabindex="-1">
                  ...
                  <span className="cart-badge badge bg-success">
                    {cartCount}
                  </span>
                </Link>
              </li>
