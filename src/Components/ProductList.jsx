...
const ProductList = () => {
  return (
    ...
    <div id="products" className="row">
       ...
       {Data.Products.map(product => <div className="col-xl-3 col-lg-4 col-md-6 position-relative">
        
        <div className="card product-item">
          {/* <i className="bi bi-heart-fill position-absolute liked"></i>
          <i className="bi bi-heart position-absolute like"></i> */}
          {/* <Link to={`/product/${product._id}`}> */}
          <img src={`images/${product.photos}.jpg`} className="card-img-top" alt="..." data-bs-toggle="tooltip" data-bs-placement="top" title="Click to See Product Details"/>
          {/* </Link> */}
